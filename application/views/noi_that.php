...
<body>
  ...
  <div id="home-slider">
        ...
        <div class="swiper-slide swiper-slide-one">
          ...
          <div class="swiper-image" data-swiper-parallax-y="35%">
            <div class="swiper-image-inner swiper-image-right swiper-image-two">
              <p class="paragraph">
                Minimalism là phong cách thể hiện sự đa dạng của nghệ thuật, đặc biệt trong nghệ thuật thị giác và âm nhạc, ở đây phẩm được yêu cầu thiết kế tối giản nhất có thể.
              </p>
            </div>
          </div>
        </div>
        <div class="swiper-slide swiper-slide-two">
          ...
          <div class="swiper-image" data-swiper-parallax-y="35%">
            <div class="swiper-image-inner swiper-image-right swiper-image-four">
              <p class="paragraph">
                Nội thất mang đường nét tối thiểu, ít chi tiết, và giảm đối đa số lượng, đặc biệt mọi chi tiết đều mang những ý nghĩa nhất định nhằm tạo ra không gian hài hòa và thông thoáng nhất.
              </p>
            </div>
          </div>
        </div>
        <div class="swiper-slide swiper-slide-three">
          ...
          <div class="swiper-image" data-swiper-parallax-y="35%">
            <div class="swiper-image-inner swiper-image-right swiper-image-six">
              <p class="paragraph">
                Nơi cung cấp các mặc hàng nội thất,nơi sáng tạo nên phong cách tối giản của bạn, đơn giản tận cùng, đơn giản hết mức có thể.
              </p>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a id="create-content" class="nav-link active" href="#content-pro1">xu hướng</a>
            </li>
            <li class="nav-item">
                <a id="create-content" class="nav-link active" href="#content-pro2">Nổi bật</a>
            </li>
            <li class="nav-item">
                <a id="create-content" class="nav-link active" href="#">Trang trí</a>
            </li>
            <li class="nav-item">
              <a id="create-content" class="nav-link active" href="#">Phong cách</a>
            </li>
            <li class="nav-item">
    ...
    <div class="text-pro" style="text-align: center; font-size: 30px; font-weight: bold;">
      <p id="content-pro1" style="font-size: 40px;">Xu hướng</p>
    </div>
      ...
      <ul class="cards_1">
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Phong cách thiết kế tối giản</h2>
              <p class="card_text_1">Trào lưu thiết kế đơn giản được mô tả với nhiều tên gọi khác nhau...</p>
        ...
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Phép trực giải</h2>
              <p class="card_text_1">Được hiểu là đơn giản hóa trong phong cách thiết kế ở nhiều lĩnh vực khác nhau...</p>
              <button class="btn card_btn">Read More</button>
            </div>
          </div>
        </li>
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Tối giản trong thiết kế</h2>
              <p class="card_text_1">loại bỏ những thiết kế rườm rà, những màu sắc không cần thiết...</p>
              <button class="btn card_btn">Read More</button>
            </div>
          </div>
        </li>
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Phong cách trong nội thất</h2>
              <p class="card_text_1">Sự mạnh mẽ, hiện đại và rõ ràng với bố cục là các đường nét, mảng khối...</p>
              <button class="btn card_btn">Read More</button>
            </div>
          </div>
        </li>
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Câu nói của Albert Einstein</h2>
              <p class="card_text_1">“Make things as simple as possible but no simpler.” - “Thực hiện những điều càng đơn giản..."</p>
              <button class="btn card_btn">Read More</button>
            </div>
          </div>
        </li>
        <li class="cards_item_1">
          <div class="card_1">
            ...
            <div class="card_content_1">
              <h2 class="card_title_1">Tông màu chính Minimalism</h2>
              <p class="card_text_1">Phối hợp các loại màu sắc tương quan, đồng điệu tạo nên sự tương phản ...</p>
              <button class="btn card_btn">Read More</button>
            </div>
          </div>
        </li>
    ...
    <div class="text-pro" style="text-align: center; font-size: 30px; font-weight: bold;">
      <p id="content-pro2" style="font-size: 40px;">Sản phẩm nổi bật</p>
    </div>
                      ...
                      <div class="card text-black">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <p class="text-muted mb-4">Sản phẩm 1</p>
                          </div>
                          <div>
                          </div>
                          <div class="d-flex justify-content-between total font-weight-bold mt-4">
                            <span>Total</span><span>100.000 <sup>đ</sup></span>
                          </div>
                        </div>
                  ...
                  <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card text-black">
                      ...
                      <div class="card-body">
                        <div class="text-center">
                          <h5 class="card-title">Believing is seeing</h5>
                          <p class="text-muted mb-4">Sản phẩm 2</p>
                        </div>
                        <div>
                        </div>
                        <div class="d-flex justify-content-between total font-weight-bold mt-4">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                  <div class="card text-black">
                    ...
                    <div class="card-body">
                      <div class="text-center">
                        <h5 class="card-title">Believing is seeing</h5>
                        <p class="text-muted mb-4">Sản phẩm 3</p>
                      </div>
                      <div>
                      </div>
                      <div class="d-flex justify-content-between total font-weight-bold mt-4">
              ...
              <div class="col-md-8 col-lg-6 col-xl-4">
                <div class="card text-black">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <h5 class="card-title">Believing is seeing</h5>
                      <p class="text-muted mb-4">Sản phẩm 4</p>
                    </div>
                    <div>
                    </div>
                    <div class="d-flex justify-content-between total font-weight-bold mt-4">
